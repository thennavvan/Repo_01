...
-- Store ID: '9000', Name: 'Books Galore', Address: '123 Main St.', 
-- City: 'Anytown', State: 'NY', Zip: '12345'

-- Exercise 2
-- Insert a new employee with the following values:
-- Employee ID: 'XYZ123', First Name: 'John', 
-- Middle Initial: 'D', Last Name: 'Smith',
-- Job ID: 6, Manager ID: 215, Department ID: '9952', 
-- Birthdate: '19800101'

-- Exercise 3
-- Insert a new sale with the following values:
-- Store ID: '7066', Product ID: 'XYZ789', 
-- Sale Date: '20230621', Quantity: 10, Terms: 'Net 30', 
-- Royalty ID: 'PS2091'
...
-- Royalty ID: 'BU1032', Min Quantity: 5000, 
-- Max Quantity: 10000, Percentage: 15
...
-- Exercise 1: Update job level of all employees to 20 
-- where current job level is less than 100
...
-- Exercise 8: Change the type of all 'business' books to 
-- 'economy'


-- Exercise 9: Set the phone number of all authors with 
-- ast name 'Smith' to '123-456-7890'
